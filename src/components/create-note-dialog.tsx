      ...
      <DialogTrigger asChild>
        {children || (
          <Button size="sm" className="h-8 gap-1">
            ...
            <span className="sr-only sm:not-sr-only sm:whitespace-nowrap">New Note</span>
          </Button>
        )}
      </DialogTrigger>
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Input id="title" name="title" placeholder="Note title" disabled={isLoading} required />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="content">Content</Label>
              <Textarea id="content" name="content" placeholder="Note content" disabled={isLoading} rows={5} />
            </div>
