...
import { CalendarDays, CheckSquare, Home, MoreHorizontal, Plus, StickyNote, Users } from "lucide-react"
...
import { createWorkspace, updateWorkspace, deleteWorkspace, inviteMember } from "@/actions/workspace-actions"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => handleInviteMember(workspace)}>Invite Member</DropdownMenuItem>
                      <DropdownMenuItem onClick={() => handleEditWorkspace(workspace)}>Edit Name</DropdownMenuItem>
                      <DropdownMenuSeparator />
                      <DropdownMenuItem onClick={() => handleDeleteWorkspace(workspace)} className="text-destructive">
                        Delete
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                    ...
                    {getWorkspaceLinks(workspace.id).map((link) => (
                      <Link
                        ...
                        className={cn(
                          ...
                          isSubLinkActive(link.href) ? "bg-accent/50 text-accent-foreground" : "text-muted-foreground",
                        )}
                      >
                        {link.icon}
                        {link.label}
        ...
        <DialogContent>
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription>Update the name of your workspace.</DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                <Label htmlFor="edit-name">Workspace Name</Label>
                <Input id="edit-name" name="name" defaultValue={selectedWorkspace?.name} placeholder="My Workspace" />
              </div>
            </div>
            <DialogFooter>
          ...
          >
            ...
            <div className="py-4">
              <p className="text-sm font-medium">
                Workspace: <span className="font-bold">{selectedWorkspace?.name}</span>
              </p>
            </div>
            <DialogFooter>
        ...
        <DialogContent>
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription>
                Invite a new member to join your workspace: {selectedWorkspace?.name}
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                <Label htmlFor="email">Email Address</Label>
                <Input id="email" name="email" type="email" placeholder="colleague@example.com" />
              </div>
            </div>
            <DialogFooter>
