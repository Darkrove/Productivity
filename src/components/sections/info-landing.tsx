    ...
    return (
        <MaxWidthWrapper large={true} className="border-dashed min-[1400px]:border-x">
            <div className="py-10 sm:py-20">
                <div className="max-w-6xl m-auto grid gap-10 px-2.5 lg:grid-cols-2 lg:items-center lg:px-7">
                    ...
                    >
                        <div className="aspect-video">
                            <Image
                                className="size-full object-cover object-center dark:bg-gray-100"
                                src={data.image}
                                alt={data.title}
                                width={1000}
                                height={500}
